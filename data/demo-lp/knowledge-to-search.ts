...
const slug = 'knowledge-to-search'
const galleryUrl = `${GALLERY_BASE}/${slug}`
const tryUrl = 'https://internal-knowledge-demo.vercel.app/'
...
export const knowledgeToSearchLp: LpConfig = {
  delivery: {
    slug,
    demoName: '社内ナレッジAI',
    demoUrl: galleryUrl,
    ogp: {
      title: '社内ナレッジAI｜答えは、もう社内にある。',
      description:
        '規程・マニュアルへの問い合わせを、探す負担から回答と出典のセットへ。その場で体験できます。',
      image: {
  ...
  brand: idealBrand,
  hero: {
    eyebrow: '規程・マニュアル・FAQを扱う企業のためのAI',
    headline: '答えは、もう社内にある。',
    subline: 'たどり着けないまま、毎日お金が消えている。',
    body: 'フォルダを開き、詳しい人に聞き、根拠のページは共有されない。同じ質問が続き、探すこと自体が仕事になる。聞けば、回答と出典がセットで返る状態へ切り替えられます。',
    ctas: [
      { label: '削減額を60秒で試算する', href: '#roi', variant: 'primary' },
      { label: 'いますぐデモを触る', href: galleryUrl, variant: 'secondary' },
    ],
    badges: ['その場で体験可', 'NDA対応可', '資料不要で開始'],
    visual: {
      src: '/images/lp/document_workflow.png',
      alt: '質問に回答と根拠が返る画面イメージ',
      note: '※画像はイメージです',
    },
  },
  impact: {
    mainFigure: {
      lead: '規程・マニュアルに関わる50人の組織では',
  ...
  process: defaultProcess('社内ナレッジ'),
  faq: defaultFaq({
    fit: '同じ社内問い合わせが繰り返し発生し、規程・マニュアルが文書として存在する組織向きです。',
    price:
      '規模と取り込み範囲で変わります。まずは試算と簡易デモで金額感を合わせてから見積もります。概算は投資回収シミュレーターでも確認できます。',
    security:
      '閲覧権限と取り込み範囲の設計が前提です。機密を無権限で広く検索させる前提にはしません。',
    accuracy:
      '最終決定の代わりにはしません。回答は確認用のたたき台とし、出典から原文確認する流れを推奨します。',
    prep: '対象文書の置き場と、誰がどの文書を見られるかが最低限あれば開始できます。',
    small: '部門・文書集合を絞ったスモールスタートが基本です。',
    env: '社内ポータル・チャットボット・既存ヘルプデスクUIへの組み込みを想定できます。',
    coexistence:
      '全文検索や既存FAQサイトと併用し、問い合わせの一次対応から置き換える導入も可能です。',
  }),
