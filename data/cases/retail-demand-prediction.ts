...
export const retailDemandPrediction: CaseStudy = {
  ...
  subtitle: '店舗 / 小売 × 需要予測',
  lead:
    '感覚で発注し、実績確認が遅い流れを、データ投入から予測値と影響要因をセットで得て判断する事例です。',
  metaTitle: '店舗 / 小売 × 需要予測 | Cases | ideal',
  metaDescription:
  ...
  contactHref: '/contact?service=ai-consulting&intent=cases&case=retail-demand-prediction',
  status: 'published',
}
