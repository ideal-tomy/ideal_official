  ...
  return (
    ...
    >
      <div className="mx-auto w-[min(100%-48px,1080px)]">
        <p className="hidden text-sm font-bold uppercase tracking-[0.12em] text-[var(--df-primary-deep)] md:block">
          デモ一覧
        </p>
        ...
        <p className="mb-10 max-w-[640px] text-[var(--df-text-muted)]">
        ...
        <div className="mt-10 flex justify-center">
          <Link
            href={GALLERY_BASE}
            className="inline-flex items-center gap-2.5 rounded-[var(--df-radius-btn)] bg-[var(--df-primary)] px-7 py-3.5 font-bold text-[var(--df-on-primary)] transition-colors hover:bg-[var(--df-primary-hover)] hover:-translate-y-0.5"
          >
            パターンデモ一覧を見る
          </Link>
        </div>
