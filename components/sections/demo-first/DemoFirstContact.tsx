...
export function DemoFirstContact() {
  return (
    <section
      id="contact"
      className="bg-[var(--df-primary)] py-[clamp(56px,12vw,88px)] text-center text-white md:py-[clamp(72px,12vw,112px)]"
    >
      <div className="mx-auto w-[min(100%-48px,1080px)]">
        <SectionKicker index="06" label="Contact" tone="inverse" />
        <h2 className="my-2 mb-6 text-[clamp(28px,6.2vw,44px)] font-black leading-[1.35] text-white">
        ...
        <p className="mx-auto mb-10 max-w-[560px] text-white/90">
        ...
        <p className="mt-8">
          <Link
            href="/estimate"
            className="text-sm font-bold text-white/90 underline-offset-4 hover:underline"
          >
            概算の感触を先に見る →
          </Link>
        </p>
