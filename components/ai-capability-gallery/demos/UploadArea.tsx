  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border-2 border-dashed border-[#D9DDE3] bg-white p-4 text-center">
        ...
        <p className="mt-1 text-[11px] text-[var(--site-fg-muted)]">
          実ファイルのアップロードは不要です
        </p>
      </div>
      ...
      <ul className="space-y-2" aria-label="アップロード済み写真一覧">
        {photos.map((photo) => (
          ...
          >
            <div
              className="h-10 w-10 rounded shrink-0 flex items-center justify-center text-[10px] text-[var(--site-fg)] font-medium"
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[11px] text-[var(--site-fg-muted)]">{photo.label}</p>
            </div>
          </li>
        ))}
      </ul>
