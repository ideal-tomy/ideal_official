    ...
    <PhilosophySectionShell id="structure" label="4. The Structure" title="価値観で進化する組織構造">
      ...
      <PhilosophyProse>
        ...
        <ul className="list-none space-y-5 ml-0">
          <li className="pl-0">
            <strong className="text-gray-100">価値観の一致が協力な引力を生む：</strong>{' '}
          ...
          <li className="pl-0">
            <strong className="text-gray-100">健全な淘汰と多様性の創出：</strong>{' '}
            フォークは、元の組織からの単なる「離脱」ではありません。
            それは、新しい価値観や創造性、技術やアイデアを持つ組織の誕生を意味します。
            これにより、社会には多様な選択肢が生まれ、健全なエコシステムの形成が期待できます。
          </li>
          <li className="pl-0">
            <strong className="text-gray-100">価値観の表明が組織の価値を強める：</strong>{' '}
        ...
        <p className="pt-6 mt-6 border-t border-gray-800/60">
