...
const PhilosophySection = React.memo(() => {
  return (
    <PhilosophySectionShell id="philosophy" label="2. The Philosophy" title="歪められた価値の再定義">
      <PhilosophyProse>
        <p>
      ...
      <Accordion items={philosophyItems} variant="card" className="mt-8 max-w-3xl" />
      ...
      <PhilosophySolutionLink sectionId="philosophy" />
    </PhilosophySectionShell>
  )
})
