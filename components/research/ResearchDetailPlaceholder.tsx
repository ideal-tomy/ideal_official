  ...
  return (
    <div className="bg-[var(--site-bg)] min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-[var(--site-fg)] mb-4">{page.title}</h1>
        <p className="text-[var(--site-fg-muted)] leading-relaxed mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          {primarySection && (
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg border border-[var(--site-border)] text-[var(--site-fg)] hover:border-gray-500 transition-colors"
            >
