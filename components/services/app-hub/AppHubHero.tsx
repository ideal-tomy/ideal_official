  ...
  return (
    <section className="relative flex min-h-[calc(100svh-4rem)] lg:min-h-[calc(100svh-5rem)] items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse 55% 45% at ${glowX}% ${glowY}%, rgba(6,182,212,0.18), transparent 70%)`,
        }}
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_20%_80%,rgba(59,130,246,0.08),transparent)]"
        aria-hidden="true"
      />
