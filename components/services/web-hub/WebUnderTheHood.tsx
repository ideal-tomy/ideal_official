      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {underTheHoodCards.map((card) => (
            ...
            >
              <div className="h-full rounded-xl border border-gray-800 bg-gray-900/40 p-5 hover:border-blue-400/40 hover:bg-gray-900/70 transition-colors text-left">
                <div className="flex items-start justify-between gap-3 mb-3">
                  <h3 className="text-lg font-semibold text-white">{card.title}</h3>
                  <span className="text-xs text-blue-400 shrink-0">開く →</span>
                </div>
