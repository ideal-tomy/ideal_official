          ...
          {capabilities.map((capability) => {
            ...
            return (
              <Link
                key={capability.id}
                href={href}
                className="group flex flex-col h-full rounded-xl border border-gray-800 bg-gray-900/40 overflow-hidden hover:border-brand/30 hover:bg-gray-900/60 transition-colors"
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  <p className="text-[11px] tracking-[0.18em] text-brand/90 mb-2">
                    {capability.englishLabel}
                  </p>
                  <h3 className="text-base font-semibold text-white mb-2 leading-snug">
                    {capability.title}
                  </h3>
                  <span className="mt-auto inline-flex items-center text-sm font-medium text-brand group-hover:text-brand-hover transition-colors">
                    デモを見る →
                  </span>
                </div>
              </Link>
